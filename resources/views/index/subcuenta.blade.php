...
@section('content')
<br><br>
<label for="HeaderC" class="form-label mt-4 ms-3"><h1><b>SUBCUENTAS</b></h1></label>

<div class="row g-3 align-items-center mb-3 ms-4 ">
  <label for="formGroupInput1" class="form-label"><b>Codigo de la Subcuenta</b></label>
  <div class="col-auto">
...
<div class="row g-3 align-items-center mb-3 ms-4 ">
  <label for="formGroupInput2" class="form-label"><b>Nombre de la Subcuenta</b></label>
  <div class="col-auto">
...
<div class="row g-3 mb-3 ms-4">
    ...
    <div class="col-auto table-responsive">
        <table class="table table-dark table-hover">
            <thead >
                <tr>
                    <th scope="col">Codigo de SubCuenta</th>
                    <th scope="col">Nombre de SubCuenta</th>
                </tr>
            </thead>
